...
<head>
  ...
  <meta http-equiv="x-ua-compatible" content="ie=edge">
  <title><?=$title?> </title>
  <base href="http://localhost/shop0903/">
...
<body class="shop_grid_page">
  ...
  <div id="mobile-menu">
    <ul>
      <li>
        <a href="index.html" class="home1">Trang chủ</a>
      </li>
      <li>
      ...
      <li>
        <a href="blog_full_width.html">Nhận xét</a>
      </li>
    </ul>
  </div>
  <!-- end mobile menu -->
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-4 col-sm-4 hidden-xs">
                ...
                <div class="welcome-msg ">Chào Bạn! </div>
                ...
                <li class="mt-root demo_custom_link_cms">
                  <div class="mt-root-item">
                    <a href="blog_full_width.html">
                      <div class="title title_font">
                        <span class="title-text">Nhận xét</span>
                      </div>
                    </a>
                  </div>
                </li>
        ...
        <div class="container">
          <div class="row">
            <div class="col-sm-6 col-xs-12 coppyright"> Copyright © 2018 MyStore. Edit by
              <a href="https://www.facebook.com"> Nguyen Chung </a>. All Rights Reserved. </div>
